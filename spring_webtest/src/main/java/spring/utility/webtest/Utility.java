...
public class Utility {
	...
	public static String boardpaging(int total, int nowPage, int recordPerPage, String col, String word, int num,
			int nPage, String url) {
		int pagePerBlock = 10; // 블럭당 페이지 수
		int totalPage = (int) (Math.ceil((double) total / recordPerPage)); // 전체 페이지
		int totalGrp = (int) (Math.ceil((double) total / pagePerBlock));// 전체 그룹
		...
		if (nowGrp >= 2) {
			str.append("<span class='span_box_1'><A href='./list.do?col=" + col + 
	...
	public static String bbspaging(int total, int nowPage, int recordPerPage, String col, String word, int bbsno,
			int nPage, String url) {
		int pagePerBlock = 10; // 블럭당 페이지 수
		int totalPage = (int) (Math.ceil((double) total / recordPerPage)); // 전체 페이지
		int totalGrp = (int) (Math.ceil((double) total / pagePerBlock));// 전체 그룹
