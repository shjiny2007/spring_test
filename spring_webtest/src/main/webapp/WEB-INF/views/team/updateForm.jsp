	...
	<input type="hidden" name="nowPage" value="${param.nowPage }">
		<table>
			...
			<tr>
				<th>주소</th>
				<td>
					<input type="text" name="address" size="45" type="text"
					id="sample6_address" value="${dto.address}"> <input
					type="text" name="address2" size="45" type="text"
					id="sample6_address2" value="${dto.address2}">
					</td>
			</tr>
		</table>
		<div>
