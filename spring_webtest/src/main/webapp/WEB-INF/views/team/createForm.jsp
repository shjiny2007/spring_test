		...
		new daum.Postcode(
				{
					oncomplete : function(data) {
						...
						document.getElementById('sample6_postcode').value = data.zonecode; //5자리 새우편번호 사
...
<body>
	...
	<form name="frm" action="./create" method="post"
		...
		<table>
			...
			<tr>
				<th>성별</th>
				<td><label><input type="radio" name="gender" value="여자">여자</label>
			...
			<tr>
				<th>주소</th>
				<td><input type="text" name="address" size="45" type="text"
					id="sample6_address" placeholder="주소"> <input type="text"
					name="address2" size="45" type="text" id="sample6_address2"
					placeholder="상세주소"></td>
			</tr>
		</table>
		<div>
